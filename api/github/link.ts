...
import { handleGithubLink } from "../../lib/api/github-link.js";
...
/** POST /api/github/link — link + prove a GitHub username to a DID, then backfill. */
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const { status, body: out } = await handleGithubLink({
    body,
    ip,
